...
Please try to follow the instructions to [Set Up Conda](https://github.com/u-ferah/IntroPythonForNeuroscientists2026/blob/main/Week01/README.md#set-up-conda), [Install VSCode](https://github.com/u-ferah/IntroPythonForNeuroscientists2026/blob/main/Week01/README.md#install-vscode), and [Set Up Github](https://github.com/u-ferah/IntroPythonForNeuroscientists2026/blob/main/Week01/README.md#Setting-Up-Github) by Tuesday, 9/15/2025 so that we have time to troubleshoot and everyone can start on the same page. Once you've set everything up, **prepare for submission to courseworks the following:**
- a screenshot of the conda version
- a screenshot of the printed "Roll a dice!" (or "hello world") in VS code
...
- Submit your github username to this [google form](https://forms.gle/FyPArUeDBRdMDteU7).
